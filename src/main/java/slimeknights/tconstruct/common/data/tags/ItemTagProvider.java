...
public class ItemTagProvider extends ItemTagsProvider {
  ...
  public ItemTagProvider(DataGenerator dataGenerator, CompletableFuture<HolderLookup.Provider> pLookupProvider, TagsProvider<Block> blockTagsProvider, @Nullable ExistingFileHelper existingFileHelper) {
    super(dataGenerator.getPackOutput(), pLookupProvider, blockTagsProvider, TConstruct.MOD_ID, existingFileHelper);
  }
  ...
  private void addTools() {
    ...
    TinkerWorld.slimeGrassSeeds.values().forEach(item -> slimySeeds.add(item.builtInRegistryHolder().key()));
