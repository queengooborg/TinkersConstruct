...
public final class TinkerMaterials extends TinkerModule {
  ...
  public static final FenceBuildingBlockObject blazewood = BLOCKS.registerFenceBuilding("blazewood", woodBuilder(MaterialColor.TERRACOTTA_RED).requiresCorrectToolForDrops().strength(25f, 300f).lightLevel(s -> 7), GENERAL_BLOCK_ITEM);
