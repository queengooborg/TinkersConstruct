...
public class ToolBuildingCategory implements IRecipeCategory<ToolBuildingRecipe> {
  ...
  public ToolBuildingCategory(IGuiHelper guiHelper) {
    this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, TinkerTools.pickaxe.get().getRenderTool());
  ...
  public ResourceLocation getUid() {
    return TConstructJEIConstants.TOOL_BUILDING.getUid();
  }

  @SuppressWarnings("removal")
  @Override
  public Class<? extends ToolBuildingRecipe> getRecipeClass() {
    return TConstructJEIConstants.TOOL_BUILDING.getRecipeClass();
  }
}
