...
public class WorldRecipeProvider extends BaseRecipeProvider implements ICommonRecipeHelper {
  ...
  protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, TinkerWorld.congealedSlime.get(SlimeType.EARTH))
    ...
    for (SlimeType slimeType : SlimeType.TINKER) {
      ...
      ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, TinkerWorld.congealedSlime.get(slimeType))
      ...
      ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, TinkerWorld.slime.get(slimeType))
                         .define('#', slimeType.getSlimeballTag())
                         .pattern("###")
                         .pattern("###")
                         .pattern("###")
      ...
      ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, TinkerCommons.slimeball.get(slimeType), 9)
    ...
    for (SlimeType slimeType : SlimeType.values()) {
      ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, TinkerCommons.slimeball.get(slimeType), 4)
  ...
  private void geodeRecipes(Consumer<FinishedRecipe> consumer, GeodeItemObject geode, SlimeType slime, String folder) {
    ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, geode.getBlock())
      .define('#', geode.asItem())
      .pattern("##")
      .pattern("##")
